		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#aymaxpfeinventaire-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aymaxpfeinventaire-display": {
								"semanticObject": "aymaxpfeinventaire",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aymax.pfe.inventaire",
									"url": sap.ui.require.toUrl("aymax/pfe/inventaire")
								}
							}
						}
					}
