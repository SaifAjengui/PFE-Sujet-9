		...
		uploadExcel: function(oEvent) {
			...
			data.forEach(row => {
				context ={
					...
					Sgtxt: row["Texte"],
					Anlu1: row["Numéro de l'immobilisation apportée/sortante pour transfert"],
					Anlu2: row["N° subsidiaire de l'immob. apportée/sortante pour transfert"],
				...
				oModel.update("/TransfertSet(Bukrs=" + "'"+context.Bukrs +"'"+','+"Anln1='"+context.Anln1 +"'"+','+"Anln2='"+context.Anln2 +"'"+ ")", context, {
